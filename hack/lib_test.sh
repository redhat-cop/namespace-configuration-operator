...
for url in git@github.com:ephico2real2/namespace-configuration-operator.git https://github.com/ephico2real2/namespace-configuration-operator.git https://github.com/ephico2real2/namespace-configuration-operator ssh://git@github.com/ephico2real2/namespace-configuration-operator.git https://github.com/ephico2real2/namespace-configuration-operator.git/ git@github.com:ephico2real2/namespace-configuration-operator.git/; do
